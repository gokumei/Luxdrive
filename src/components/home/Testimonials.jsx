      ...
      <div className="mx-auto max-w-[1500px] px-6 md:px-12">
        <Reveal>
          <div className="text-center max-w-2xl mx-auto mb-20">
            <span className="text-xs tracking-[0.3em] uppercase text-gold mb-4 block">{t('reviews.label')}</span>
            <h2 className="font-display text-4xl md:text-6xl text-ivory leading-[1.05]">{t('reviews.title')}</h2>
          </div>
        </Reveal>
