...
/**
 * @typedef {{ baseUrl: string, filename: string }} ParsedWixMedia
 * @typedef {{ x: number, y: number }} FocalPoint
 * @typedef {"fill" | "fit"} FittingType
 ...
 * static.wixstatic.com are served resized to the rendered container
 * (per device pixel ratio) and re-encoded to WebP; `fittingType="fill"`
 * crops server-side, optionally anchored at a focal point. Other URLs render as a
